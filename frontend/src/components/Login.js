    ...
    <div>
      <div className="container-fluid ">
        ...
        <div className='col leftcol p-0' >
          <img className='img-fluid leftcol' src="https://cdn.dribbble.com/users/2561416/screenshots/15218794/login_background_4x.png" alt="" />
          ...
          <div className="col d-flex justify-content-center rightcol p-0 text-light">
            ...
            <form onSubmit ={handleSubmit} className='myform'>
              ...
              <div className="form-outline mb-4 myinput">
                <input type="email" id="form2Example1" className="form-control bg-light" value={values.email} onChange={handleChange} name="email"/>
              ...
              <div className="form-outline mb-4  myinput">
                <input type="password" id="form2Example2" className="form-control bg-light" value={values.passwordl} onChange={handleChange} name="password" />
